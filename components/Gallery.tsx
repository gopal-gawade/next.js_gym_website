...
export default function Gallery() {
    ...
    return (
        <div className="bg-black p-6 mx-auto text-center text-md leading-loose flex flex-col items-center justify-center">
            <h1 className={`${oswald.className} text-4xl md:text-5xl font-extrabold uppercase mb-6 text-[#e63946] tracking-wide text-center gap-2 flex items-center justify-center`}>
                Inside the
                <Image
                    src={'/logo.jpg'}
                    alt='Lio Fit'
